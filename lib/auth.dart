...
class AuthMethods {
  ...
  Future<Map<String, dynamic>> checkEmail(String email) async {
    ...
    if (response.statusCode == 200) {
      return {'ok': true, 'message': jsonDecode(response.body)['message']};
    }

    return {'ok': false, 'message': jsonDecode(response.body)['message']};
  }

  Future<Map<String, dynamic>> verifyArtistTwitter(
      String twitterEmail, String twitterName, String twitterNickname) async {
